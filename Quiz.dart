...
class Quiz{
  ...
  String getQuestion(){
    return this._quesList[_quesNum].question;
  }

  void nextQuestion(){
    if(_quesNum < this._quesList.length){
      _quesNum++;
    }
  }

  bool check(bool b){
    return this._quesList[_quesNum].tf == b;
  }

  bool ended(){
    return this._quesNum == this._quesList.length - 1;
  }
